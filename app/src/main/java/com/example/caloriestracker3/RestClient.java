...
//add http headers to set your response type to json
    ...
    //(http://localhost:8080/NewC/webresources/newc.credential)
    //credential

    public static String findAllCredential(String subPath) {
        //final String methodPath = "/smarter.usage/findByResid/2";
        final String methodPath = "/newc.credential/";
//initialise
        URL url = null;
        HttpURLConnection conn = null;
        String textResult = "";
...
//add http headers to set your response type to json
    ...
    //http://localhost:8080/NewC/webresources/newc.credential/findByUsername/haha
    ...
    public static String getPasswordByUsername(String userName)
    {
        ...
        try{
            jsonArray = new JSONArray(findAllCredential("findByUsername/"  + userName+ "?"));
            JSONObject oneObject =  jsonArray.getJSONObject(0);

            res = String.valueOf(oneObject.getString("passwordHarsh"));
...
/*
    public static  String getAllOfCategory()
    {
        final String methodPath = "NewC.food/";
        //initialise
        URL url = null;
        HttpURLConnection conn = null;
        String textResult = "";
